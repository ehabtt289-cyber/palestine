...
export const STATIC_IMAGES: Record<string, string[]> = {
  ...
  Knafeh: [W("f/f7/Knafeh.jpg", 1000)],
  "Knafeh Nabulsieh": [W("f/f7/Knafeh.jpg", 1000)],
  "Zaatar Palestine": [W("4/4e/Za%27atar.jpg", 1000)],
  "Palestinian thobe": [W("c/c1/Palestinian_embroidery_-_close-up.jpg", 1000)],
  "Palestinian thobe dress": [W("c/c1/Palestinian_embroidery_-_close-up.jpg", 1000)],
  Keffiyeh: [W("2/24/Keffiyeh.jpg", 1000)],
  "Palestinian tatreez embroidery": [W("c/c1/Palestinian_embroidery_-_close-up.jpg", 1000)],
  "Palestinian embroidery tatreez": [W("c/c1/Palestinian_embroidery_-_close-up.jpg", 1000)],
  Dabke: [W("8/80/Dabke_dance.jpg", 1000)],
  "Dabke dance": [W("8/80/Dabke_dance.jpg", 1000)],
  "Al-Aqsa Mosque": [W("a/ac/Dome_of_the_Rock%2C_Jerusalem_4.jpg", 1200)],
  "Church of the Nativity": [W("5/5a/Bethlehem_BW_2010-12-12_07-29-15.JPG", 1200)],
  "Sebastia Palestine": [W("a/ab/Nablus_old_city.jpg", 1200)],
  "Palestinian culture": [
